...
//            actionBar.setDisplayHomeAsUpEnabled(true);
    ...
    public static class AlarmPreferenceFragment extends PreferenceFragment {
        ...
        public void onCreate(Bundle savedInstanceState) {
            ...
            // updated to reflect the new value, per the Android Design
            // guidelines.
            bindPreferenceSummaryToValue(findPreference("alarm_new_message_ringtone"));
            ...
            prefListener = new SharedPreferences.OnSharedPreferenceChangeListener() {
                ...
                public void onSharedPreferenceChanged(SharedPreferences prefs, String key) {
                    ...
                    if(key.equals("alarm_new_message")|| key.equals("alarm_time")){
                        NotificationScheduleAlarm.Change(prefs, getActivity());
                    }
                }
            };
